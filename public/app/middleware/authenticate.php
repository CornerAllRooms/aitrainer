...
{
    private $users;
    private $publicRoutes = ['/', '/register', '/password-reset'];
    ...
    public function process($request, RequestHandlerInterface $handler): ResponseInterface
    {
        ...
        if (empty($_SESSION['user']['email'])) {
            ...
            return $this->redirect('/'); // Redirect to index.php (login)
        }
    ...
    {
        return in_array($path, $this->publicRoutes) || str_starts_with($path, '/public/');
    }
